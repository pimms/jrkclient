...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="jrkKitWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ServerConfiguration")
...
@interface ServerConfiguration (SWIFT_EXTENSION(jrkKitWatch))
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, copy) NSURL * _Nullable url;
@end


SWIFT_CLASS("_TtC11jrkKitWatch12StreamPlayer")
