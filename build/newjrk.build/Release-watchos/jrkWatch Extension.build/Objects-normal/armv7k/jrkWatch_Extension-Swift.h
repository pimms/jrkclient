...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="jrkWatch_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class WKRefreshBackgroundTask;

SWIFT_CLASS("_TtC18jrkWatch_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC18jrkWatch_Extension15MessageReceiver")
...
@interface MessageReceiver (SWIFT_EXTENSION(jrkWatch_Extension)) <WCSessionDelegate>
...
- (void)session:(WCSession * _Nonnull)_ didReceiveApplicationContext:(NSDictionary<NSString *, id> * _Nonnull)_;
@end
