...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="newjrk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6newjrk11AppDelegate")
...
SWIFT_CLASS("_TtC6newjrk16GradientBlurView")
@interface GradientBlurView : UIView
...
SWIFT_CLASS("_TtC6newjrk27InitialConfigViewController")
@interface InitialConfigViewController : UIViewController
- (void)viewDidLoad;
...
@interface InitialConfigViewController (SWIFT_EXTENSION(newjrk)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC6newjrk11LoadingView")
...
SWIFT_CLASS("_TtC6newjrk21LoadingViewController")
...
SWIFT_CLASS("_TtC6newjrk12LogEntryCell")
...
SWIFT_CLASS("_TtC6newjrk17LogViewController")
...
@interface LogViewController (SWIFT_EXTENSION(newjrk)) <UITableViewDelegate>
@end

@class UITableView;

@interface LogViewController (SWIFT_EXTENSION(newjrk)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC6newjrk20PlayerViewController")
...
SWIFT_CLASS("_TtC6newjrk13RoundedButton")
...
SWIFT_CLASS("_TtC6newjrk13SceneDelegate")
...
SWIFT_CLASS("_TtC6newjrk15WatchConnection")
@interface WatchConnection : NSObject
...
@interface WatchConnection (SWIFT_EXTENSION(newjrk)) <WCSessionDelegate>
